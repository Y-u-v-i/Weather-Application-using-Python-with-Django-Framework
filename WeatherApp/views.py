...
def home(request):
    url='http://api.openweathermap.org/data/2.5/weather?q={}&appid=879685ad7544306def8c9efb5b228834&units=metric'
...
def delete_city(request,CName):
    ...
    messages.warning(request," "+CName+" Removed Successfully...!!!")
